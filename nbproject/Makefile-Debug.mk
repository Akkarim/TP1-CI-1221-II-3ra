...
${OBJECTDIR}/AlgoritmosArbol.o: AlgoritmosArbol.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AlgoritmosArbol.o AlgoritmosArbol.cpp
...
${OBJECTDIR}/Arbol/arrSPadre.o: Arbol/arrSPadre.cpp
	${MKDIR} -p ${OBJECTDIR}/Arbol
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arbol/arrSPadre.o Arbol/arrSPadre.cpp

${OBJECTDIR}/Arbol/hijoIzqHD1.o: Arbol/hijoIzqHD1.cpp
	${MKDIR} -p ${OBJECTDIR}/Arbol
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arbol/hijoIzqHD1.o Arbol/hijoIzqHD1.cpp

${OBJECTDIR}/Arbol/hijoIzqHD2.o: Arbol/hijoIzqHD2.cpp
	${MKDIR} -p ${OBJECTDIR}/Arbol
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arbol/hijoIzqHD2.o Arbol/hijoIzqHD2.cpp

${OBJECTDIR}/Arbol/hijoIzqHD3.o: Arbol/hijoIzqHD3.cpp
	${MKDIR} -p ${OBJECTDIR}/Arbol
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arbol/hijoIzqHD3.o Arbol/hijoIzqHD3.cpp
